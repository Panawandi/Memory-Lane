...
namespace ML.Controllers
{
    public class FortniteController : Controller
    {
        public IActionResult Fortnite()
        {
            ...
            var videoDirectory = Path.Combine(Directory.GetCurrentDirectory(), "wwwroot", "videos", "Fortnite");

            // Get all .mp4 files in the Fortnite directory
        ...
        // Other Fortnite controller actions
    }
}